 ...
 * Use the [TweetWithGifDetailDialogFragment.newInstance] factory method to
...
class TweetWithGifDetailDialogFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TweetWithGifDetailDialogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TweetWithGifDetailDialogFragment().apply {
