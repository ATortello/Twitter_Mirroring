 ...
 * Use the [TweetOnlyTextDetailDialogFragment.newInstance] factory method to
...
class TweetOnlyTextDetailDialogFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TweetOnlyTextDetailDialogFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TweetOnlyTextDetailDialogFragment().apply {
